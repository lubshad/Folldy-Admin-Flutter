...
class ChapterDetailsController extends ChangeNotifier {
  AddPresentationToChapter addPresentationToChapter =
      AddPresentationToChapter(Get.find());
  ...
  void addPresntations(List<Presentation> selectedPresentations) async {
    final response = await addPresentationToChapter(AddPresentaionChapterParams(
