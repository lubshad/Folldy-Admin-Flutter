...
class GetAllFacultys extends UseCase<List<Faculty>, FacultyListingParams> {
  ...
  @override
  Future<Either<AppError, List<Faculty>>> call(FacultyListingParams params) async {
...
class FacultyListingParams {
  ...
  factory FacultyListingParams.fromJson(String source) => FacultyListingParams.fromMap(json.decode(source));
}
