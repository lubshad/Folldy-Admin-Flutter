...
class GetAllChapters extends UseCase<List<Chapter>, ChapterListingParams> {
  ...
  @override
  Future<Either<AppError, List<Chapter>>> call(ChapterListingParams params) async {
...
class ChapterListingParams {
  ...
  factory ChapterListingParams.fromJson(String source) => ChapterListingParams.fromMap(json.decode(source));
}
