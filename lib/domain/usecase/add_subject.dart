...
class AddNewSubject extends UseCase<Map<String, dynamic>, AddSubjectParams> {
  ...
  @override
  Future<Either<AppError, Map<String, dynamic>>> call(AddSubjectParams params) async {
...
class AddSubjectParams {
  ...
  AddSubjectParams({required this.name, required this.semester, this.id, required this.course});
  ...
  factory AddSubjectParams.fromJson(String source) => AddSubjectParams.fromMap(json.decode(source));
}
