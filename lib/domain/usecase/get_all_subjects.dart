...
class GetAllSubjects extends UseCase<List<Subject>, SubjectListingParams> {
  ...
  @override
  Future<Either<AppError, List<Subject>>> call(SubjectListingParams params) async {
...
class SubjectListingParams {
  ...
  factory SubjectListingParams.fromJson(String source) => SubjectListingParams.fromMap(json.decode(source));
